...
export const BANNER_PRESETS: BannerPreset[] = [
  ...
  // Pill-shaped CTA buttons with trailing ">" arrow
  {
    id: "pill-green",
    label: "Road trip >",
    font_family: "Inter", font_weight: 800,
    text_color: "#ffffff", bg_color: "#4ca84c",
    radius: 999, padding_x: 44, padding_y: 22,
  },
  {
    id: "pill-blue",
    label: "Let's go >",
    font_family: "Inter", font_weight: 800,
    text_color: "#ffffff", bg_color: "#2563eb",
    radius: 999, padding_x: 44, padding_y: 22,
  },
  {
    id: "pill-red",
    label: "Watch now >",
    font_family: "Inter", font_weight: 800,
    text_color: "#ffffff", bg_color: "#e11d48",
    radius: 999, padding_x: 44, padding_y: 22,
  },
  {
    id: "pill-orange",
    label: "Get started >",
    font_family: "Inter", font_weight: 800,
    text_color: "#ffffff", bg_color: "#f97316",
    radius: 999, padding_x: 44, padding_y: 22,
  },
  {
    id: "pill-purple",
    label: "Join us >",
    font_family: "Inter", font_weight: 800,
    text_color: "#ffffff", bg_color: "#8b5cf6",
    radius: 999, padding_x: 44, padding_y: 22,
  },
  {
    id: "pill-black",
    label: "Tap in >",
    font_family: "Inter", font_weight: 800,
    text_color: "#ffffff", bg_color: "#0a0a0a",
    radius: 999, padding_x: 44, padding_y: 22,
  },
  {
    id: "pill-yellow",
    label: "New drop >",
    font_family: "Inter", font_weight: 800,
    text_color: "#0a0a0a", bg_color: "#facc15",
    radius: 999, padding_x: 44, padding_y: 22,
  },
  {
    id: "pill-teal",
    label: "Explore >",
    font_family: "Inter", font_weight: 800,
    text_color: "#ffffff", bg_color: "#0d9488",
    radius: 999, padding_x: 44, padding_y: 22,
  },
];
